...
A full-stack DailyDash application built with **React** and **Vite** for the frontend and **Express**, **MongoDB**, **JWT**, and **Zod** for the backend. This application allows users to register, log in, and manage their tasks.
...
/DailyDash/
 ...
 │
 └── README.md                               # Project README file with details and instructions
...
- **MongoDB**: As the NoSQL database to store users and tasks
